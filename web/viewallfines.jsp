...
<head>
    ...
    <style>
        ...
        * {
        ...
        .stat-icon.paid { background: var(--gradient-success); }
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarMain">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link active" href="<%= role.equals("Student") ? "student_dashboard.jsp" : "librarian_dashboard.jsp" %>">
    ...
    <div class="dashboard-container">
        ...
        <div class="welcome-header">
            ...
            <p class="text-muted">Track and manage all library fines and penalties</p>
            <div class="user-info">
                ...
                <table id="finesTable" class="table table-striped table-bordered" style="width:100%">
                    ...
                    <tbody>
                        <% 
                            ...
                            try {
                                DBCon db = new DBCon();
                                // Modified query to include payment status if exists, otherwise all are pending
                        ...
                        %>
                        <tr>
                            <td colspan="9" class="text-center text-danger">Error loading fine records. Please try again.</td>
                        </tr>
                        <% } %>
                    </tbody>
                </table>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#finesTable tbody tr').each(function() {
                let amountText = $(this).find('td:eq(6)').text();
                let amount = parseInt(amountText.replace('₹', ''));
                let status = $(this).find('td:eq(8) .status-badge').text();
            ...
            $('#totalFines').text('₹' + totalFines.toLocaleString());
