...
<body>
        ...
        <div class="container">
            ...
            <a class="navbar-brand" href="librarian_dashboard.jsp">
                ...
                <div>
                    ...
                    <span class="brand-subtext">Return Books</span>
                </div>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarMain">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="return_book.jsp">
    ...
    <div class="content-container">
        <div class="info-message">
            ...
            Process book returns and calculate fines for overdue books.
        </div>
        ...
        <div class="form-container">
            <div class="form-header">
                ...
                <h2>Return Book</h2>
                <p class="text-muted">Enter book and student details to process return</p>
            </div>
            ...
            <form action="ReturnBookServlet" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="rollNo" name="student_roll_number" 
                ...
                <% if (fineAmount > 0) { %>
                    <div class="fine-display">
                        ...
                        <div class="clear-fine-link">
                            <a href="viewallfines2.jsp">
                                <i class="fas fa-rupee-sign"></i> Clear Fine
                            </a>
                        </div>
            ...
            <a href="Search Issued Books.jsp" class="btn-back">
                <i class="fas fa-search"></i> View Issued Books
            </a>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('form').submit(function(e) {
                ...
                var rollNumber = $('#rollNo').val().trim();
                
                if (!bookId || !rollNumber) {
