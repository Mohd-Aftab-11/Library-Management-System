    ...
    <style>
        ...
        * {
        ...
        @media (max-width: 768px) {
            ...
            .btn-danger-custom, .btn-secondary {
                width: 100%;
                max-width: 300px;
            }
        }
        ...
        <div class="container">
            ...
            <a class="navbar-brand" href="librarian_dashboard.jsp">
                ...
                <div>
                    ...
                    <span class="brand-subtext">Delete Book</span>
                </div>
            </a>
    ...
    <div class="content-container">
        ...
        <div class="form-container">
            <div class="form-header">
                ...
                <p class="text-muted">Enter the Book ID to permanently remove a book from the library collection</p>
            </div>

            <!-- Warning Message -->
            <div class="warning-box">
                <h5><i class="fas fa-exclamation-triangle mr-2"></i>Warning: This Action Cannot Be Undone</h5>
                <p>Deleting a book will permanently remove it from the library database. This action cannot be reversed. Please verify the Book ID before proceeding.</p>
            </div>

            <form action="DeleteBookServlet" method="post" id="deleteBookForm">
                <div class="form-group">
                    <label for="book_id" class="form-label required">
                        <i class="fas fa-barcode"></i>Book ID to Delete
                    </label>
                    <input type="text" class="form-control" id="book_id" name="book_id" required 
                           placeholder="Enter the Book ID you want to delete">
                    <small class="form-text text-muted">
                        <i class="fas fa-info-circle mr-1"></i>
                        You can find Book ID from the Book List or Search Books page
                    </small>
                </div>

                <div class="button-group">
                    <button type="submit" class="btn-danger-custom" id="deleteBtn">
                        <i class="fas fa-trash-alt"></i> Delete Book Permanently
                    </button>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-6 mb-4">
                    ...
                    <a href="viewallbooks.jsp"><i class="fas fa-chevron-right mr-2"></i>Book List</a>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#deleteBookForm').submit(function(e) {
                ...
                if (confirm('?? WARNING: This will permanently delete the book with ID: ' + bookId + '\n\nThis action cannot be undone. Are you sure you want to proceed?')) {
                    // Show loading state
                    const deleteBtn = $('#deleteBtn');
                    const originalText = deleteBtn.html();
                    deleteBtn.html('<i class="fas fa-spinner fa-spin"></i> Deleting Book...');
