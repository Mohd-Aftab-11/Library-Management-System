...
<head>
    ...
    <title>Search Attendance - Library Management System</title>
...
<body>
        ...
        <div class="container">
            ...
            <a class="navbar-brand" href="librarian_dashboard.jsp">
                ...
                <div>
                    ...
                    <span class="brand-subtext">Search Attendance</span>
                </div>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarMain">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="search_attendance.jsp">
                            <i class="fas fa-clipboard-list mr-2"></i>Search Attendance
                        </a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="content-container">
        <div class="info-message">
            ...
            Enter student details to view their attendance records.
        </div>
        ...
        <div class="form-container">
            <div class="form-header">
                ...
                <p class="text-muted">Enter roll number and name to find attendance records</p>
            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('form').submit(function(e) {
                ...
                if (!confirm('Search attendance for:\n\nRoll Number: ' + rollNumber + '\nStudent Name: ' + studentName)) {
                    e.preventDefault();
                    return false;
                }
